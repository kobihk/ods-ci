...
Is RHODS Installed
  ...
  IF  "${cluster_type}" == "selfmanaged"
      IF  "${INSTALL_TYPE}" == "Cli"
          ...
          ...  Run Keywords
          ...  Check A RHODS Family Operator Is Installed  namespace=${OPERATOR_NAMESPACE}  AND
...
Check A RHODS Family Operator Is Installed
  [Documentation]   Returns if RHODS operator has a CSV in the given namespace
  [Arguments]    ${namespace}
...
Get RHODS Subscription Name
    ...
    ...    oc get subscriptions -A | grep ${RHODS_PACKAGE_NAME} | awk '{print $2}'
